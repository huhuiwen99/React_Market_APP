        ...
        <form onSubmit={onSubmit}>
          ...
          <div className='formRooms flex'>
            <div>
              ...
              <input className='formInputSmall' type='number' id='bedrooms' value={bedrooms}
                onChange={onMutate} min='1' max='50' required />
            </div>
            <div>
              <label className='formLabel'>Bathrooms</label>
              <input className='formInputSmall' type='number' id='bedrooms' value={bathrooms}
                onChange={onMutate} min='1' max='50' required />
            </div>
          </div>
          ...
          {offer && (
            <>
              ...
              <input className='formInputSmall' type='number' id='regularPrice' value={discountedPrice}
              onChange={onMutate} min='50' max='750000000' required />
            </>
          )}
          ...
          <input className='formInputFile' type='file' id='images'
            onChange={onMutate} max='6' accept='.jpg,.png,.jpeg' multiple required />
